...
\begin{frame}
  \frametitle{Test projects}
    ...
    \item some are heavy template meta-programming,
    \item some code is not analyzed,
    \item {\larger $\approx$ 6300 LOC}.
    \end{itemize}
    \item Project 2:
    \begin{itemize}
    \large
    ...
    \item {\larger $\approx$ 135k LOC}.
    \end{itemize}
    \item Project 3:
    \begin{itemize}
    \large
    \item proprietary, production code for embedded HW,
    \item {\larger $\approx$ 750k LOC}.
    \end{itemize}
    \end{itemize}
\end{frame}
% ------------------------------------------------------------------------------
...
% ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Project 1 -- build times}
  \fitfig{project1_build_times}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Project 2 -- build times}
  \fitfig{project2_build_times}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Project 3 -- build times}
...
\begin{frame}
  \frametitle{Conclusions}
    ...
    \item Using \cmdname{clang-tidy-cache} (and \cmdname{ccache})
        significantly improves build times for projects of various sizes.
    \item The achieved speedups are in the range TODO.
    \end{itemize}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}
