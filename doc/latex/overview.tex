...
\begin{frame}[fragile]
  \frametitle{Test projects}
    \Large
    \begin{itemize}
    \item Project 1 (proprietary C++ training examples)
    \begin{itemize}
    \large
    \item some are heavy template meta-programming,
    \item $\approx{}6300$ LOC.
    \end{itemize}
    \item Project 2 (open-source C++ wrapper for EGL, OpenGL, OpenAL, \ldots)
    \begin{itemize}
    \large
    \item \url{https://github.com/matus-chochlik/oglplu2},
    \item $\approx{}135k$ LOC.
    \end{itemize}
    \item Project 3 (proprietary, production code for embedded HW)
    \begin{itemize}
    \large
    \item $\approx{}670k$ LOC.
    \end{itemize}
    \end{itemize}
\end{frame}
% ------------------------------------------------------------------------------
